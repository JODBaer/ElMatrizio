...
\begin{document}
	...
	Löst man die Gleichung für \(x'_{3}\) und \(x''_{3}\) auf und berechnet die Position der Linse 4 kommt man auf das Ergebnis, dass die Linse 4 nur um .8 mm verschoben werden muss, damit die Linse in beiden Positionen scharf abbildet. Dies ist sogleich die Antwort auf die Zweite Frage.
	\section{Aufgabe 2}
